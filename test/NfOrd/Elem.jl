@testset "Elements" begin
  ...
  @testset "Construction" begin
    ...
    @test parent(b1) == O1
    @test typeof(b1) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}

    b2 = @inferred O1(2)
    @test parent(b2) == O1
    @test typeof(b2) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}
    @test b1 == b2

    b3 = @inferred O1(ZZRingElem(2))
    @test parent(b3) == O1
    @test typeof(b3) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}
    @test b1 == b3

    b4 = @inferred O1([2, 0, 0])
    @test parent(b4) == O1
    @test typeof(b4) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}
    @test b4.has_coord
    @test b1 == b4

    b5 = @inferred O1([FlintZZ(2), FlintZZ(0), FlintZZ(0)])
    @test parent(b5) == O1
    @test typeof(b5) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}
    @test b5.has_coord
    @test b1 == b5

    b6 = @inferred O1(2*a1^0, [FlintZZ(2), FlintZZ(0), FlintZZ(0)])
    @test parent(b6) == O1
    @test typeof(b6) == AbsNumFieldOrderElem{AbsSimpleNumField, AbsSimpleNumFieldElem}
    @test b6.has_coord
    @test b1 == b6
