@testset "FieldFactory" begin
  ...
  @time begin
    @testset "Some examples" begin
      ...
      f = x^24 + 12*x^23 + 12*x^22 - 372*x^21 - 1224*x^20 + 4192*x^19 + 22370*x^18 - 17518*x^17
         - 198383*x^16 - 30608*x^15 + 1017900*x^14 + 582696*x^13 - 3257224*x^12 - 2385744*x^11 
          + 6751956*x^10 + 4794056*x^9 - 9162405*x^8 - 4964804*x^7 + 7887120*x^6 + 2258008*x^5 
          - 3853388*x^4 - 85944*x^3 + 797010*x^2 - 160358*x + 1483
