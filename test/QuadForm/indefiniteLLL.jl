...
#######################################################
  ...
  function _find_gamma(H::MatElem{fmpq})
  ...
  @test find_gamma(change_base_ring(QQ,H5)) <= find_gamma(change_base_ring(QQ,G5))
  ...
  @test find_gamma(change_base_ring(QQ,H6)) <= find_gamma(change_base_ring(QQ,G6))
  ...
  #@test find_gamma(change_base_ring(QQ,H7)) <= find_gamma(change_base_ring(QQ,G7))
