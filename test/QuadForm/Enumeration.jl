@testset "Minima and Kissing numbers" begin
  D = lattice_database()
  _minima = fmpz[ minimum(lattice(D, i)) for i in 1:300]
  @test _minima == [2, 1, 1, 1, 2, 2, 1, 2, 2, 1, 2, 3, 2, 3, 1, 2, 2, 3, 6,
                    1, 2, 1, 2, 3, 4, 2, 2, 1, 2, 1, 2, 2, 2, 1, 2, 2, 2, 1, 2,
                    3, 4, 2, 2, 4, 2, 4, 2, 2, 2, 4, 4, 2, 2, 4, 2, 3, 2, 4, 4,
                    6, 2, 2, 3, 1, 2, 5, 3, 4, 2, 4, 2, 2, 4, 4, 4, 7, 4, 2, 6,
                    4, 4, 4, 2, 4, 2, 4, 2, 3, 3, 2, 7, 2, 4, 2, 3, 2, 2, 4,
                    12, 2, 4, 6, 6, 8, 6, 8, 6, 6, 8, 6, 3, 6, 6, 4, 6, 6, 6,
                    4, 4, 4, 4, 4, 4, 4, 4, 2, 2, 4, 6, 4, 4, 10, 6, 4, 6, 4,
                    8, 2, 8, 2, 4, 2, 2, 2, 2, 4, 8, 4, 8, 3, 3, 4, 6, 6, 2, 9,
                    2, 4, 4, 16, 4, 4, 4, 3, 3, 2, 2, 10, 4, 6, 3, 2, 4, 4, 16,
                    4, 3, 4, 2, 11, 60, 2, 4, 4, 12, 4, 4, 4, 8, 4, 4, 8, 4, 2,
                    12, 2, 8, 2, 4, 6, 2, 2, 4, 2, 4, 2, 2, 2, 2, 2, 2, 15, 12,
                    4, 4, 4, 4, 4, 3, 4, 2, 13, 3, 5, 2, 4, 4, 9, 4, 4, 4, 3,
                    2, 14, 4, 4, 4, 4, 2, 4, 2, 4, 4, 4, 4, 4, 4, 7, 6, 6, 2,
                    15, 2, 3, 2, 4, 4, 4, 4, 4, 4, 4, 3, 3, 8, 6, 8, 12, 12, 8,
                    10, 6, 10, 4, 2, 16, 6, 8, 4, 4, 4, 4, 8, 6, 8, 4, 6, 2, 4,
