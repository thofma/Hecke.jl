...
function _coprime_ideal(C::FinGenAbGroup, mC::Map, m::AbsNumFieldOrderIdeal{AbsSimpleNumField, AbsSimpleNumFieldElem})
  ...
  mp.header=AbstractAlgebra.MapHeader(C,Hecke.AbsNumFieldOrderIdealSet{AbsSimpleNumField, AbsSimpleNumFieldElem}(O),exp, mC.header.preimage)
...
#
  ...
  mp.header = AbstractAlgebra.MapHeader(X, Hecke.AbsNumFieldOrderIdealSet{AbsSimpleNumField, AbsSimpleNumFieldElem}(O), expo, disclog)
  mp.modulus_fin=m
  mp.modulus_inf=p
...
#
  ...
  mp.header = AbstractAlgebra.MapHeader(X, FacElemMon(parent(m)) , expon, disclog)
  mp.modulus_fin=n
