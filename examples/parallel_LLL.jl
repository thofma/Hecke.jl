...
function minkowski_matrix_parallel(O::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}, abs_tol::Int = 64)
...
@doc raw"""
    minkowski_gram_mat_scaled(O::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}, prec::Int = 64) -> ZZMatrix
...
"""
function minkowski_gram_mat_scaled_parallel(O::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}, prec::Int = 64)
...
function parallel_lll_precomputation(M::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}, prec::Int, nblocks::Int = 4)
  n = degree(M)
  K = nf(M)
  ...
  while !all(done)
    ...
    On = AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}(K, g*basis_matrix(M, copy = false))
