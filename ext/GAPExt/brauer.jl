...
function assure_isomorphism(F::FieldsTower, G)
  ...
  D = Dict{NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}, GAP.GapObj}()
...
function pSylow(Gperm::GAP.GapObj, permGAP::Vector{GAP.GapObj}, G::Vector{NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}}, p::Int)
  ...
  Gp = Vector{Hecke.NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}}(undef, lGp)
  j = 1
  for ind = 1:length(G)
    if j > lGp
      break
...
function _obstruction_prime_no_extend(x::FieldsTower, cocycles, p::Int)
  ...
  for i = 1:length(obstruction)
    if isdefined(cocycles[i], :inclusion_of_pSylow)
      ...
      Gp1 = NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}[]
      for g in GC
...
function _obstruction_pp(F::FieldsTower, cocycles::Vector{cocycle_ctx}, pv::Int)
  ...
  for i = 1:length(obstruction)
    ...
    Stab = NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}[]
...
function issplit_at_P(O::NfOrd, G::Vector{NumFieldHom{AbsSimpleNumField, AbsSimpleNumField}}, Coc::Function, P::NfOrdIdl, n::Int, Rx::fpPolyRing)
