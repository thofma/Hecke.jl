...
function _as_algebra_over_center(A::AlgAss{T}) where { T } #<: Union{QQFieldElem, fpFieldElem, EuclideanRingResidueFieldElem{ZZRingElem}, FqPolyRepFieldElem, fqPolyRepFieldElem} }
  @assert !iszero(A)
