...
function _from_submodules_to_ideals(M::ModAlgAss, O::AlgAssAbsOrd, I::AlgAssAbsOrdIdl, x::Union{FqMatrix, Zmodn_mat, Generic.Mat{EuclideanRingResidueFieldElem{ZZRingElem}}}, A1::AlgAss, OtoA1::AbsOrdToAlgAssMor)
