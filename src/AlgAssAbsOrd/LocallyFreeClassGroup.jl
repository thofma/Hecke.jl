...
function locally_free_class_group(O::AlgAssAbsOrd, cond::Symbol = :center, return_disc_log_data::Type{Val{T}} = Val{false}) where T
  ...
  @vprint :LocallyFreeClassGroup "Decomposing algebra\n"
  Adec = decompose(A)
  ...
  @vprint :LocallyFreeClassGroup "Compute ray class group\n"
  ...
  @vprint :LocallyFreeClassGroup "Compute K_1\n"
  k1 = K1_order_mod_conductor(O, OA, F, FinZ)

  k1_as_subgroup = Vector{elem_type(R)}()
  @vprint :LocallyFreeClassGroup "Lift generators to units of the algebra\n"
  for x in k1
  ...
  @vprint :LocallyFreeClassGroup "Compute quotient\n"
