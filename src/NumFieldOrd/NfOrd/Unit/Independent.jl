...
@doc raw"""
    unit_group_rank(O::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem}) -> Int

Returns the unit rank of $\mathcal O$, that is, the rank of the unit group
$\mathcal O^\times$.
"""
function unit_group_rank(O::AbsNumFieldOrder{AbsSimpleNumField, AbsSimpleNumFieldElem})
