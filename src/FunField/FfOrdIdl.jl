...
mutable struct FfOrdIdl
  ...
  function FfOrdIdl(O::GenOrd, M::MatElem)
  ...
  function FfOrdIdl(O::GenOrd, x::GenOrdElem)
  ...
  function FfOrdIdl(O::GenOrd, x::RingElem)
    return FfOrdIdl(O,O(x))
  end

  function FfOrdIdl(O::GenOrd, T:: Vector)
  ...
  function FfOrdIdl(O::GenOrd, p::RingElem, a::GenOrdElem)
    #  create ideal of O generated by x
    r = FfOrdIdl(O)
    r.gen_one = p
    r.gen_two = a
...
@doc Markdown.doc"""
    basis(A::FfOrdIdl) -> Vector{GenOrdElem}
...
function Hecke.mod(x::GenOrdElem, y::FfOrdIdl)
  parent(x) !== order(y) && error("GenOrds of element and ideal must be equal")
...
function Hecke.prime_decomposition(O::GenOrd, p::RingElem, degree_limit::Int = degree(O), lower_limit::Int = 0; cached::Bool = true)
...
function _decomposition(O::GenOrd, I::FfOrdIdl, Ip::FfOrdIdl, T::FfOrdIdl, p::RingElem)
...
function Hecke.AlgAss(O::GenOrd, I::FfOrdIdl, p::RingElem)
  @assert order(I) === O
