...
function isconductor(S::GrpAbFinGen, mS::GrpAbFinGenMap, R::GrpAbFinGen, mR::MapRayClassGrp, m::NfOrdIdl, infinite_places::Array{InfPlc,1}=InfPlc[])
...
doc"""
***
  function norm_group(f::Nemo.PolyElem, mR::Hecke.MapRayClassGrp, fin_modulus::NfOrdIdl, inf_modulus::Array{InfPlc,1}=InfPlc[]) -> Hecke.FinGenGrpAb, Hecke.FinGenGrpAbMap
...
function norm_group(f::Nemo.PolyElem, mR::Hecke.MapRayClassGrp, fin_modulus::NfOrdIdl, inf_modulus::Array{InfPlc,1}=InfPlc[])
