...
doc"""
***
    ray_class_group(m::NfMaxOrdIdl, A::Array{Int64,1} (optional)) -> GrpAbFinGen, Map
...
***
  ...
  function isconductor(R::GrpAbFinGen, mR::Map, m::NfMaxOrdIdl, infinite_primes::Array{InfPlc,1}=[])
...
doc"""
***
  function norm_group(f::Nemo.GenPoly, R::GrpAbFinGen, mR::MapRayClassGrp) -> Hecke.GrpAbFinGen, Hecke.GrpAbFinGenMap
...
function norm_group(f::Nemo.PolyElem, R::GrpAbFinGen, mR::Hecke.MapRayClassGrp)
