...
function ResidueRingPolyMap_image{D, C, T}(M::ResidueRingPolyMap{D, C}, a::GenRes{T})
...
function ResidueRingPolyMap_preimage{D, C, T}(M::ResidueRingPolyMap{D, C}, a::GenRes{T})
