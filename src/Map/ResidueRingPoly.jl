...
#end
#
#function ResidueRingPolyMap_image(M::ResidueRingPolyMap{D, C}, a::Generic.Res{T}) where {D, C, T}
...
#end
#
#function ResidueRingPolyMap_preimage(M::ResidueRingPolyMap{D, C}, a::Generic.Res{T}) where {D, C, T}
