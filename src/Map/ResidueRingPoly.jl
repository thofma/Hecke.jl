...
function ResidueRingPolyMap_image(M::ResidueRingPolyMap{D, C}, a::GenRes{T}) where {D, C, T}
...
function ResidueRingPolyMap_preimage(M::ResidueRingPolyMap{D, C}, a::GenRes{T}) where {D, C, T}
