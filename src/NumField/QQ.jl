...
#function hom(::FlintRationalField, L::NumField)
#  z = NumFieldMor{FlintRationalField, typeof(L), elem_type(L), fmpq}()
#  return z
#end
...
#
map_data(K::FlintRationalField, L, ::Bool; check = true) = MapDataFromQQ{elem_type(L)}(true)
...
function map_data(K::FlintRationalField, L, g::NumFieldMor; check = true)
  if check
