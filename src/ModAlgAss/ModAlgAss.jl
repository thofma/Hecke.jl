...
function regular_module(A::AbsAlgAss, p)#::AbsAlgAssMor)
  K = base_ring(A)
...
function free_module(A::AbsAlgAss, r::Int)
  K = base_ring(A)
  n = dim(A)
  B = basis(A)
...
function Amodule(A::AbsAlgAss, B::Vector{<:Vector}; is_basis::Bool = true)
  @assert is_basis
